...
const ItemsCarouselTwo: React.FC<IItemsCarouselProps> = ({dataOne, dataTwo, dataThree, title}) => {
    const elementRefs = [
    ...
    return (
        <Container>
            ...
            <TrendingItemsContainer>
                <CarouselContainer >
                    <PreviewItems transitionActive={transitionActive} dataArr={dataThreeSplitTwo}
                    ...
                    <PreviewItems transitionActive={transitionActive} dataArr={dataTwoSplitOne}
                                  ref={elementRefs[3]} left={520*2} />
                    <PreviewItems transitionActive={transitionActive} dataArr={dataTwoSplitTwo}
                                  ref={elementRefs[4]} left={520*3} />
                    <PreviewItems transitionActive={transitionActive} dataArr={dataThreeSplitOne}
                                  ref={elementRefs[5]} left={520*4} />
                    <PreviewItems transitionActive={transitionActive} dataArr={dataThreeSplitTwo}
                                  ref={elementRefs[6]} left={520*5} />
                    <PreviewItems transitionActive={transitionActive} dataArr={dataOneSplitOne}
