...
import {IFrontPageItem} from "../product-page-with-searchbar/product-page-with-searchbar";
...
const SearchBar: React.FC<ISearchBarProps> = forwardRef((props, ref) => {
    ...
    return (
        <SearchBarContainer>
            {
                <Dropdown ref={searchBarRef} setDisplayDataIndex={setDisplayDataIndex} dropdownValue={dropdownValue} setDropdownValue={setDropdownValue} dropdownOpen={dropdownOpen}
